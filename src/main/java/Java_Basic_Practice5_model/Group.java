...
public class Group extends StructuralUnit {
    ...
    public Group(String title, Date dateOfCreation, Specialty specialty, Employee curator) throws UnitException {
        super(title);
    ...
    public Group(String title, Date dateOfCreation, Employee curator) throws UnitException {
        super(title);
        this.dateOfCreation = dateOfCreation;
        this.curator = curator;
    }
